...
func (_m *Usecase) GetArticle(id uint64) (article *models.Article, err error) {
	ret := _m.Called(id)
...
func (_m *Usecase) SaveArticle(article *models.Article) (id uint64, err error) {
...
func (_m *Usecase) ListArticle(limit uint64, offset uint64) ([]*models.Article, error) {
